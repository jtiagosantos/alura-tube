export const playlists = {
  ...
  'back-end': [
    ...
    {
      title: 'O que é o Java? #HipstersPontoTube',
      url: 'https://www.youtube.com/watch?v=90NcVNsKGik',
      thumb: 'https://img.youtube.com/vi/90NcVNsKGik/hqdefault.jpg',
    },
    {
      title: 'O que é Machine Learning? #HipstersPontoTube',
      url: 'https://www.youtube.com/watch?v=Iuz_jc96bQk',
      thumb: 'https://img.youtube.com/vi/Iuz_jc96bQk/hqdefault.jpg',
    },
    {
      title:
        'A MELHOR linguagem de programação com Fabio Akita | #HipstersPontoTube',
      url: 'https://www.youtube.com/watch?v=imB0QVoNrGc',
      thumb: 'https://img.youtube.com/vi/imB0QVoNrGc/hqdefault.jpg',
    },
    {
      title:
        'Top 5 libs que todo aplicativo Android deve ter com Alex Felipe | #HipstersPontoTube',
      url: 'https://www.youtube.com/watch?v=ldRbnpy-qQs',
      thumb: 'https://img.youtube.com/vi/ldRbnpy-qQs/hqdefault.jpg',
    },
    {
      title: 'O que é o C#? #HipstersPontoTube',
      url: 'https://www.youtube.com/watch?v=0JWMVc1CqpA',
      thumb: 'https://img.youtube.com/vi/0JWMVc1CqpA/hqdefault.jpg',
    },
  ],
};
